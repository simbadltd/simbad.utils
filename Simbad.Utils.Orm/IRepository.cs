...
{
    public interface IRepository<TEntity, TId, in TContext> where TEntity : class, IEntity<TId>, IAggregationRoot
    {
        ...
        TEntity FindSingle(IDbConnection connection, IDbTransaction transaction, TContext context, ISpecification<TEntity, TId> specification = null);
        ...
        ICollection<TEntity> FindMany(IDbConnection connection, IDbTransaction transaction, TContext context, ISpecification<TEntity, TId> specification = null);

        ICollection<TEntity> FindMany(GroupOperator op, params ISpecification<TEntity, TId>[] specifications);

        ICollection<TEntity> FindMany(GroupOperator op, TContext context, params ISpecification<TEntity, TId>[] specifications);
        ...
        ICollection<TEntity> FindMany(IDbConnection connection, IDbTransaction transaction, GroupOperator op, TContext context, params ISpecification<TEntity, TId>[] specifications);
