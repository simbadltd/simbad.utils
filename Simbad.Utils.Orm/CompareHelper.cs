...
namespace Simbad.Utils.Orm
{
    ...
    {
        public static bool CompareObjects(object inputObjectA, object inputObjectB, ICollection<PropertyInfo> propertiesToCompare = null)
        {
            ...
            if (inputObjectA != null && inputObjectB != null)
            {
                ...
                var properties = propertiesToCompare ??
                ...
                foreach (var propertyInfo in properties)
                {
                    ...
                    else if (IsEnumerableType(propertyInfo.PropertyType))
                    {
                        ...
                        CompareEnumerations(value1, value2);
                    }
                        //if it is a class object, call the same function recursively again
                    else if (propertyInfo.PropertyType.IsClass)
                    {
                        if (
                            !CompareObjects(propertyInfo.GetValue(inputObjectA, null),
        ...
        private static bool CompareEnumerations(object value1, object value2)
        {
            ...
            else if (value1 != null && value2 != null)
            {
                ...
                else
                {
                    ...
                    for (int itemIndex = 0; itemIndex < enumValue1.Count(); itemIndex++)
                    {
                        ...
                        else if (!CompareObjects(enumValue1Item, enumValue2Item))
                            return false;
                    }
                }
            }
